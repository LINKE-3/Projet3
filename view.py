...
class View:
    ...
    def display_wall(self):
        Wall = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\wall.png")
        Wall.convert()
    ...
    def display_floor(self):
        Floor = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\floor.png")
        Floor.convert()
    ...
    def display_hero(self,mcgyver):
        MacGyver = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\MacGyver.png")
        #load image
        MacGyver.convert()
        #convert l'image
    ...
    def display_items(self):
        ...
        needle = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\1.png")
        needle = pygame.transform.scale(needle, [needle.get_width() - 500, needle.get_height() - 650])
        needle.convert()
        Ether = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\2.png")
        Ether = pygame.transform.scale(Ether, [Ether.get_width() - 175, Ether.get_height() - 175])
        Ether.convert()
        syringe = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\0.png")
    ...
    def arrive(self):
        black = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\black.png")
        black = pygame.transform.scale(black, [black.get_width() - 10, black.get_height() - 10])
        black.convert()
        guardian = pygame.image.load("C:\\Users\\alain\\Documents\\Open Classroom\\P3_Linke_Marin\\guardian.png")
        guardian.convert()
